...
var PeerConnectionClient = function(params, startTime) {
  ...
  this.onerror = null;
  // This happens when the total connection state changes like from
  // connecting to being connected.
  this.oniceconnectionstatechange = null;
  // This function will be called, whenever a new
  // ice candidate is found, weather its an ICE candidate
  // generated locally, or if its an ICE candidate received
  // from the remote end. This is normally done to record the
  // ICE exchange.
  this.onnewicecandidate = null;
  // This is called when the remote side
  // hangsup. So here we'll need to handle
  // the closing of the peerconnection object.
  this.onremotehangup = null;
  // This is called when we have set the offer
  // or answer as the remote description.
  this.onremotesdpset = null;
  // This happens when the remote side adds
  // their stream to their pc object. So, here
  // we need to get the stream and bind it to our
  // video element.
  this.onremotestreamadded = null;
  // This is called whenever peerconnectionclient - (this) object
  // needs to send a message to the other side.
  this.onsignalingmessage = null;
  // This is called whenever there is a change in the
  // state if ICE Signaling. This is where we can hook
  // ICE failure and do an ice restart or something.
